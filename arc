...
(parameterize ((current-namespace (make-base-empty-namespace)))
  ...
  (profile-thunk (lambda ()
    ...
    #|(let (;(exec-dir (namespace-variable-value 'exec-dir* #f))
      ...
      (ac-load (build-path exec-dir "02 core.arc"))
      (ac-load (build-path exec-dir "03 ssyntax.arc"))
      ;(ac-load "compat.arc")
      (ac-load (build-path exec-dir "04 arc.arc"))
      ;(ac-load "lib/re.arc")
      ;(ac-load "lib/script.arc")
      (ac-load (build-path exec-dir "05 import.arc"))
      (ac-load (build-path exec-dir "06 extra.arc"))
